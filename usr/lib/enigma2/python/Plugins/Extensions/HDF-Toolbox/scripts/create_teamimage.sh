...
opkg install enigma2-plugin-extensions-movie2kfilme enigma2-plugin-extensions-flashexpander enigma2-plugin-extensions-tvcharts
...
opkg install enigma2-plugin-extensions-infobartunerstate enigma2-plugin-extensions-cacheflush
echo
