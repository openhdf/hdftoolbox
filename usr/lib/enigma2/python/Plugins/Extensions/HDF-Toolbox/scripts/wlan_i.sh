...
opkg install rt5572 enigma2-plugin-drivers-network-usb-rt5572 kernel-module-mwifiex-usb kernel-module-rtlwifi oe-alliance-wifi enigma2-plugin-drivers-network-usb-rtl8192cu
echo
