...
echo
echo "install addons"
opkg install enigma2-plugin-extensions-Burnseries enigma2-plugin-extensions-webradiofs
opkg install enigma2-plugin-extensions-mediaportal enigma2-plugin-extensions-tvkino
